...
class TextReader():
	...
	def _load(self):
		...
		self.train_label = load_pkl(processed_train_path.replace('_data.pkl', '_label.pkl')).astype(int)

		self.valid_data = load_pkl(processed_valid_path)
		self.valid_label = load_pkl(processed_valid_path.replace('_data.pkl', '_label.pkl')).astype(int)

		self.test_data = load_pkl(processed_test_path)
		self.test_label = load_pkl(processed_test_path.replace('_data.pkl', '_label.pkl')).astype(int)
